class EnemyAI {
    ...
    moveYDir(mag = 0.15, friction = 0.975) {
        this.enemy.body.setVelocity((this.enemy.body.velocity.x + mag * Math.sin(this.enemy.body.rotation.y)) * friction, this.enemy.body.velocity.y, (this.enemy.body.velocity.z + mag * Math.cos(this.enemy.body.rotation.y)) * friction);
    }
}